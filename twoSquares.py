...
START_BLOCKS = [(pg.Color("blue"), (350,200)),(pg.Color("blue"), (200,250)), (pg.Color("blue"), (350,100)),  (pg.Color("blue"), (200,150)),(pg.Color("blue"), (100,250))]
START_BLOCKS2 = [(pg.Color("red"), (450,100)),(pg.Color("red"), (400,250)), (pg.Color("red"), (350,350)),  (pg.Color("red"), (600,150)),(pg.Color("red"), (550,250))]
...
STATIC_BLOCKS = [(pg.Color("green"), (50,50)), (pg.Color("green"), (50,100)),(pg.Color("green"), (100,50)),(pg.Color("green"), (600,400)),(pg.Color("green"), (550,400)),(pg.Color("green"), (600,350))]

if bitmap[8] == 1:
    STATIC_BLOCKS.append((pg.Color("gray"), (150,100)))
if bitmap[7] == 1:
    STATIC_BLOCKS.append((pg.Color("gray"), (150,150)))
if bitmap[0] == 1:
    STATIC_BLOCKS.append((pg.Color("gray"), (50,150)))
if bitmap[1] == 1:
    STATIC_BLOCKS.append((pg.Color("gray"), (150,50)))
if bitmap[2] == 1:
    STATIC_BLOCKS.append((pg.Color("gray"), (100,150)))
if bitmap[3] == 1:
    STATIC_BLOCKS.append((pg.Color("gray"), (500,400)))
if bitmap[4] == 1:
    STATIC_BLOCKS.append((pg.Color("gray"), (500,350)))
if bitmap[5] == 1:
    STATIC_BLOCKS.append((pg.Color("gray"), (500,300)))
if bitmap[6] == 1:
    STATIC_BLOCKS.append((pg.Color("gray"), (550,300)))
if bitmap[9] == 1:
    STATIC_BLOCKS.append((pg.Color("gray"), (600,300)))
#if bitmap[10] == 1:
    #STATIC_BLOCKS.append((pg.Color("gray"), (150,350)))
#if bitmap[11] == 1:
    #STATIC_BLOCKS.append((pg.Color("gray"), (150,300)))
...
class Block(pg.sprite.Sprite):
    ...
    def __init__(self, color, position):
        ...
        self.quitRunning2 = True
        self.keepRunning = False
        self.keepRunning2 = False
    ...
    def update(self, screen_rect, others, col):
        """
        ...
        if(test or self.keepRunning):
            ...
            if(self.quitRunning):
                #print ("made it here")
                coordinates = [[299,351,401,349],[349,401,401,349],[200,200,450,400],[400,400,450,400],[150,150,450,400],[150,150,400,350],[150,150,350,300],[451,451,450,400],[451, 451,400,350],[451,451,350,300],[501,501,550,500]]
    ...
    def updateRed(self, screen_rect, others):
        """
        Update position; check collision with other blocks; and check
        collision with screen boundaries.
        """
...
class Control(object):
    ...
    def main_loop(self):
        ...
        while not self.done:
            ...
            self.blocks.update(self.screen_rect, self.blocks, False)
            #if(target==3):
            self.blocks3.update(self.screen_rect, self.blocks3, True)
            #if(target==4):
