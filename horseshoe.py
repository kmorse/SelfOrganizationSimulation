...
START_BLOCKS = [(pg.Color("pink"), (550,300)),(pg.Color("pink"), (500,50)), (pg.Color("pink"), (750,200)),  (pg.Color("pink"), (200,150)),(pg.Color("pink"), (650,250)), (pg.Color("pink"), (400,150)), (pg.Color("pink"), (200,250)), (pg.Color("pink"), (600,150)), (pg.Color("pink"), (600,50))]
...
STATIC_BLOCKS = [(pg.Color("green"), (350,400)), (pg.Color("green"), (250,400)),(pg.Color("green"), (300,400))]

if bitmap[8] == 1:
    STATIC_BLOCKS.append((pg.Color("gray"), (150,400)))
if bitmap[7] == 1:
    STATIC_BLOCKS.append((pg.Color("gray"), (451,400)))
if bitmap[0] == 1:
    STATIC_BLOCKS.append((pg.Color("gray"), (400,400)))
if bitmap[1] == 1:
    STATIC_BLOCKS.append((pg.Color("gray"), (451,350)))
if bitmap[2] == 1:
    STATIC_BLOCKS.append((pg.Color("gray"), (450,400)))
if bitmap[3] == 1:
    STATIC_BLOCKS.append((pg.Color("gray"), (451,400)))
if bitmap[4] == 1:
    STATIC_BLOCKS.append((pg.Color("gray"), (451,300)))
if bitmap[5] == 1:
    STATIC_BLOCKS.append((pg.Color("gray"), (451,250)))
if bitmap[6] == 1:
    STATIC_BLOCKS.append((pg.Color("gray"), (200,400)))
if bitmap[9] == 1:
    STATIC_BLOCKS.append((pg.Color("gray"), (451,200)))
if bitmap[10] == 1:
    STATIC_BLOCKS.append((pg.Color("gray"), (150,350)))
if bitmap[11] == 1:
    STATIC_BLOCKS.append((pg.Color("gray"), (150,300)))
if bitmap[12] == 1:
    STATIC_BLOCKS.append((pg.Color("gray"), (150,250)))
if bitmap[13] == 1:
    STATIC_BLOCKS.append((pg.Color("gray"), (150,200)))
