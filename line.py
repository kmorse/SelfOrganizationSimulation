...
START_BLOCKS = [(pg.Color("darkorchid"), (100,350)),(pg.Color("darkorchid"), (400,50)), (pg.Color("darkorchid"), (250,200)),  (pg.Color("darkorchid"), (200,150)),(pg.Color("darkorchid"), (100,250)), (pg.Color("darkorchid"), (400,150))]
...
#if bitmap[7] == 1:
    #STATIC_BLOCKS.append((pg.Color("gray"), (550,400)))
if bitmap[0] == 1:
    ...
    def update(self, screen_rect, others):
        ...
        if(test or self.keepRunning):
            ...
            if(self.quitRunning):
                ...
                coordinates = [[299,351,401,349],[349,401,401,349],[200,200,450,400],[400,400,450,400],[450,450,450,400],[500,500,450,400],[150,150,450,400],[550, 550,450,400],[150,150,450,400]]
